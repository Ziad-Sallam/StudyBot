...
class QueryHandler:
    ...
    def __init__(self):
        ...
        self.get_synonyms = ["get", "retrieve", "fetch", "obtain", "acquire"]
        self.create_synonyms = ["create", "build", "make", "produce", "construct", "generate"]
    ...
    def identify_query(self, query, threshold=0.5):
        ...
        print(contains_get, contains_create)
        ...
        # Threshold check
        return most_similar if max_similarity > threshold else "none"
